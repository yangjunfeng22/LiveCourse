...
- (void) layoutSubviews {
    ...
    CGFloat textSizeWidth = (self.textLabel != nil) ? [self.textLabel sizeWithFont:self.label.font constrainedToSize:maxLabelSize lineBreakMode:NSLineBreakByCharWrapping].width : 0;
    ...
    // 根据大小, 自动缩放字体.
    CGFloat fontSize;
    [self.textLabel sizeWithFont:self.label.font minFontSize:6.0f actualFontSize:&fontSize forWidth:self.label.bounds.size.width lineBreakMode:NSLineBreakByCharWrapping];

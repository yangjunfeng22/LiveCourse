...
-(void)keyboardImgManageImageSelectedDelegate:(NSData *)imageData{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(keyboardToolBarDelegateImageDataSelect:)]) {
        [self.delegate keyboardToolBarDelegateImageDataSelect:YES];
    }
}
...
-(void)keyboardImgManageImageDeleteDelegate{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(keyboardToolBarDelegateImageDataSelect:)]) {
        [self.delegate keyboardToolBarDelegateImageDataSelect:NO];
    }
...
-(void)keyBoardVoiceManageVoiceSelectedDelegate:(NSData *)voiceData andDuration:(NSInteger)duration{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(keyboardToolBarDelegateAudioDataSelect:)]) {
        [self.delegate keyboardToolBarDelegateAudioDataSelect:YES];
    }
}
...
-(void)keyBoardVoiceManageVoiceDeleteDelegate{
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(keyboardToolBarDelegateAudioDataSelect:)]) {
        [self.delegate keyboardToolBarDelegateAudioDataSelect:NO];
    }
}
